...
#define QSPI_BK1_D0_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOC_CLK_ENABLE()//注意修改启动的时钟源
...
#define QSPI_BK1_D3_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOA_CLK_ENABLE()//注意修改启动的时钟源
...
#define QSPI_BK1_D0_PIN                 GPIO_PIN_9 //QSPI_BK1_D0
...
#define QSPI_BK1_D3_PIN                 GPIO_PIN_1 //QSPI_BK1_D3
